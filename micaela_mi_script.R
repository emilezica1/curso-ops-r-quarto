...
base <- base |>
  mutate(
    caso_grave = case_when(
      CUIDADO_INTENSIVO == "SI" | VM == "1" | OXIGENOTERAPIA_ALTO_FLUJO == "1" ~ "SI",
    ...
    soporte = case_when(
      VM == "1"                        ~ "Ventilación mecánica",
      OXIGENOTERAPIA_ALTO_FLUJO == "1" ~ "Alto flujo",
      OXIGENOTERAPIA_BAJO_FLUJO == "1" ~ "Bajo flujo",
